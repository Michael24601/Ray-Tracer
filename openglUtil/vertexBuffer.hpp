/*
    A util class that allows easy sending of vertex data to 
    shadrs. 
*/
...
public:
    ...
    */
    ...
    // The constructor only reserves the space; it does not send data
    VertexBuffer(
        int vertexNumber,
        const std::vector<unsigned int>& attributeSizes,
        unsigned int topologyType,
        ...
        attributeNumber{unsigned (attributeSizes.size())},
        vertexNumber{vertexNumber},
        topologyType{ topologyType }, 
        vao{ 0 }, 
        vbo{0} {

        // We only allow triangles and lines
    ...
    /*
        ...
        This function basically sets the vertex data of one
        attribute (like normal, vertices, etc...)
    */
