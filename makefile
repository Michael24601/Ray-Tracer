...
INCLUDES = -I./include -I./glm-master/glm -I./glfw-3.3.8.bin.WIN32/include -I./glew-2.2.0/include -I./stb
...
# Object files (moves them to the build directory)
OBJS = $(SRCS:.cpp=.o)
OBJS := $(patsubst %.o,build/%.o,$(OBJS))

# Output executable
TARGET = build\my_program.exe
